...
public class AdminEditProfileActivity extends AppCompatActivity {
        ...
        FirebaseApiService.apiService.getUserById(userId).enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(AdminEditProfileActivity.this, "Không tải được dữ liệu!", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<User> call, Throwable t) {
                Toast.makeText(AdminEditProfileActivity.this, "Lỗi tải dữ liệu!", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        FirebaseApiService.apiService.updateUser(userId, user).enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(AdminEditProfileActivity.this, "Mật khẩu đã được cập nhật!", Toast.LENGTH_SHORT).show();
                    edtPassword.setText(""); // Xóa trường nhập mật khẩu sau khi cập nhật
                } else {
                    Toast.makeText(AdminEditProfileActivity.this, "Cập nhật mật khẩu thất bại!", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<User> call, Throwable t) {
                Toast.makeText(AdminEditProfileActivity.this, "Lỗi mạng! Không thể cập nhật mật khẩu.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private final ActivityResultLauncher<Intent> imagePicker = registerForActivityResult(
            ...
            result -> {
                if (result.getData() != null && result.getResultCode() == RESULT_OK) {
                    ...
                    Toast.makeText(AdminEditProfileActivity.this, "Không chọn được ảnh!", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void uploadImageToFirebase() {
        ...
        storageRef.putFile(imgUri).addOnSuccessListener(taskSnapshot ->
                ...
                Toast.makeText(AdminEditProfileActivity.this, "Tải ảnh lên thất bại!", Toast.LENGTH_SHORT).show()
        );
    }
        ...
        FirebaseApiService.apiService.updateUser(userId, user).enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(AdminEditProfileActivity.this, "Cập nhật thất bại!", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<User> call, Throwable t) {
                Toast.makeText(AdminEditProfileActivity.this, "Cập nhật thất bại! Lỗi mạng hoặc kết nối", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
