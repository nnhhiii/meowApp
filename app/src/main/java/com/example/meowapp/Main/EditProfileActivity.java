...
public class EditProfileActivity extends AppCompatActivity {
        ...
        FirebaseApiService.apiService.updateUser(userId, user).enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(EditProfileActivity.this, "Mật khẩu đã được cập nhật!", Toast.LENGTH_SHORT).show();
                    edtPassword.setText(""); // Xóa trường nhập mật khẩu sau khi cập nhật
                } else {
                    Toast.makeText(EditProfileActivity.this, "Cập nhật mật khẩu thất bại!", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<User> call, Throwable t) {
                Toast.makeText(EditProfileActivity.this, "Lỗi mạng! Không thể cập nhật mật khẩu.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private final ActivityResultLauncher<Intent> imagePicker = registerForActivityResult(
            ...
            result -> {
                if (result.getData() != null && result.getResultCode() == RESULT_OK) {
                    ...
                    Toast.makeText(EditProfileActivity.this, "Không chọn được ảnh!", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void updateUserData() {
        FirebaseApiService.apiService.updateUser(userId, user).enqueue(new Callback<User>() {
            ...
            @Override
            public void onFailure(Call<User> call, Throwable t) {
                Toast.makeText(EditProfileActivity.this, "Cập nhật thất bại! Lỗi mạng hoặc kết nối", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
